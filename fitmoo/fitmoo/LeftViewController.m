...
- (void)viewDidLoad {
    ...
    _imageArray= [[NSArray alloc] initWithObjects: @"home.png",@"follow.png",@"notification.png",@"cart_sidemenu.png",@"productIcon.png",@"purchases.png",@"earnings.png",@"fitmoolive.png", nil];
